          ...
          <div className="w-full max-w-6xl">
            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-stretch">
              ...
              <div className="relative group flex-1">
                {/* Image Container */}
                <div className="relative overflow-hidden rounded-2xl shadow-2xl border border-[var(--nav-border-color)] h-full">
                  <img
                  ...
                  />
                  {/* Overlay on hover */}
                  <div className="absolute inset-0 bg-[var(--nav-text-hover)] opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                </div>
