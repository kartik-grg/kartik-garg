  ...
  const socialLinks: SocialLink[] = [
    {
      ...
      href: personalInfo?.social_links?.github || "https://github.com/yourusername",
      label: "GitHub",
    },
    {
      icon: <FaLinkedin className="w-6 h-6" />,
      href: personalInfo?.social_links?.linkedin || "https://linkedin.com/in/yourusername",
      label: "LinkedIn",
    },
    {
      icon: <SiLeetcode className="w-6 h-6" />,
      href: leetcodeProfile?.profile_url || personalInfo?.social_links?.portfolio || "https://leetcode.com/yourusername",
      label: "LeetCode",
    },
  ];
