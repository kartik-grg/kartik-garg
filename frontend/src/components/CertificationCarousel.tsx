  ...
  return (
    <div className="relative w-full flex items-center justify-center gap-8">
      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="relative w-full h-96 md:h-[28rem] overflow-hidden">
          {/* Certificate Image */}
          <img
            src={currentCert.image}
            alt={currentCert.name}
            className="w-full h-full object-cover transition-all duration-500 group-hover/card:blur-sm group-hover/card:scale-110"
            onError={(e) => {
              (e.target as HTMLImageElement).src = 'https://via.placeholder.com/800x600/374151/9CA3AF?text=Certificate';
            }}
          />
