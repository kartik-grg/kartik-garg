...
Express.js backend server for Kartik Garg's portfolio website. Provides RESTful APIs for managing portfolio content, authentication, and admin operations with Google OAuth integration.
